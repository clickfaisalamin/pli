		...
		<div class="col-md-6 offset-md-3">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<form action="addpli"  method="post">
						<div class="mb-3">
						
							<label for="txtname" class="form-label">Name</label>
							<input type="text" class="form-control"  placeholder="Enter Your Name Here" id="txtname" name="txtname">
						</div>
						
						<div class="mb-3">
						
							<label for="txtcourse" class="form-label">Course</label>
							<input type="text" class="form-control"  placeholder="Enter Your Name Here" id="txtcourse" name="txtcourse">
						</div>
						...
						<div class="mb-3">
							...
							<input class="form-control" list="datalistOptions"
								id="exampleDataList" placeholder="Type to search..." name="txtstatus">
